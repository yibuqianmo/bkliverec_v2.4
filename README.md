...
兼容 Windows XP 系统，但是由于 XP 系统太过老旧，一些新的重要协议不再受支持，导致软件的部分功能受限无法正常工作，建议升级到 Windows 7 或更高的系统以体验完整的软件功能。

### 下载与安装

* 最新稳定版本下载(V2.4.0.1855)：**[Github Release]()** 或 **[官网下载]()** 或 **[百度网盘下载]()**。
* 解压并运行安装包安装，等待完成即可。
...
下面对软件的基本操作进行简单讲解，可以快速掌握软件使用方法。

#### 直播、视频页面地址直接解析下载

* 1、主界面，主菜单->任务->新建录制任务`Ctrl+N`；
* 2、在弹出的“添加新任务”窗口，将视频页面地址粘贴到“采集来源”；
* 3、点击“解析”按钮，等待解析完成；
...
* 3、再打开的“主播资料提取”窗口，将复制的直播间地址粘贴到“提取来源”文本框中，点击“按钮”；
* 4、提取主播资料成功后，再确认窗口中对主播资料进行修改与完善；
* 5、配置智能录制，回到主窗口，主菜单->任务->配置智能录制`Ctrl+T`;
* 6、左侧树列表选择“所属平台分组”，找到新添加的主播，双击“保存位置”单元格设置录制视频保存位置，双击“计划”单元格设置是否启用自动录制；
* 7、回到主窗口，主菜单->任务->启动智能录制，可以通过观察主窗口左下方的状态信息了解自动录制情况（双击左下角的任务图标可以快速启动或终止智能录制功能）。
